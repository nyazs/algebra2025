...
bgimgselect.addEventListener("change", () => {
	switch (bgimgselect.value) {
		case "default":
			...
			break;
		case "audi":
			changeBackground("wallpapers/audi.gif", "audi");
			break;
		case "windows":
			changeBackground("wallpapers/windows.webp", "windows");
			break;
		case "windowsdark":
			changeBackground("wallpapers/windowsdark.webp", "windowsdark");
			break;
	}
});
...
const cloaks = [
	...
	{
		name: "drive",
		icon: "cloaks/googledrive.png",
		title: "Home - Google Drive",
	},
	{
		name: "edpuzzle",
		icon: "cloaks/edpuzzle.png",
		title: "Edpuzzle",
	},
	{
		name: "wikipedia",
		icon: "cloaks/wikipedia.ico",
		title: "Wikipedia",
	},
	{
		name: "classroom",
		icon: "cloaks/Classroom.png",
		title: "Google Classroom",
	},
	{
		name: "canvas",
		icon: "cloaks/canvas.png",
		title: "Dashboard",
	},
	{
		name: "classroom",
	...
	{
		name: "zoom",
		icon: "cloaks/zoom.png",
		title: "Zoom",
	},
	{
		name: "khan",
		icon: "cloaks/khan.ico",
		title: "Khan Academy",
	},
	{
		name: "desmos",
		icon: "cloaks/desmos.ico",
		title: "Desmos Classroom Activities",
	},
	{
		name: "gforms",
		icon: "cloaks/googleforms.png",
		title: "Start your quiz",
	},
	{
		name: "quizlet",
		icon: "cloaks/quizlet.webp",
